...
export function Head() {
  return (
    <>
      ...
      <meta name="description" content="Parcours d'obstacles unique : cette page illustre une anomalie spécifique pour le SEO." />
      ...
      <meta property="og:title" content="Parcours d'obstacles Noyaru - Page de test unique" />
      ...
      <meta name="twitter:title" content="Parcours d'obstacles Noyaru - Page de test unique" />
