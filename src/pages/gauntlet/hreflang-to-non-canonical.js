...
export function Head() {
  return (
    <>
      ...
      <meta name="description" content="Découvrez le parcours d'obstacles avec hreflang vers une page non canonique, illustrant un cas spécifique à explorer dans notre test." />
