...
export function Head() {
  return (
    <>
      ...
      <title>Parcours d'obstacles : duplicate b - Test de duplication</title>
      <meta name="description" content="Découvrez le parcours d'obstacles 'duplicate b', une page unique qui illustre une anomalie de duplication pour les développeurs." />
      <link rel="canonical" href="https://noyaru-stack-gatsby.netlify.app/gauntlet/duplicate-b/" />
      <meta property="og:type" content="article" />
      <meta property="og:title" content="Parcours d'obstacles : duplicate b - Test de duplication" />
      ...
      <meta name="twitter:title" content="Parcours d'obstacles : duplicate b - Test de duplication" />
