...
export function Head() {
  return (
    <>
      ...
      <title>Parcours d'obstacles - Test de doublons SEO</title>
      <meta name="description" content="Parcours d'obstacles : cette page sert à tester les anomalies SEO dans le cadre d'un parcours d'obstacles." />
