...
export function Head() {
  return (
    <>
      ...
      <title>Parcours d'obstacles : duplicate b - Test unique</title>
      <meta name="description" content="Découvrez le parcours d'obstacles 'duplicate b', une page dédiée à une anomalie unique dans notre test." />
      <link rel="canonical" href="https://noyaru-stack-gatsby.netlify.app/gauntlet/duplicate-b/" />
      <meta property="og:type" content="article" />
      <meta property="og:title" content="Parcours d'obstacles : duplicate b - Test unique" />
      ...
      <meta name="twitter:title" content="Parcours d'obstacles : duplicate b - Test unique" />
