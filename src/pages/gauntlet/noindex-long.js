...
export function Head() {
  return (
    <>
      ...
      <meta name="description" content="Une meta description trop longue pour dépasser le plafond de 160 caractères, afin de déclencher les descriptions trop longues sur une page non indexable." />
