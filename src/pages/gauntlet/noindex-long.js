...
export function Head() {
  return (
    <>
      ...
      <meta name="description" content="Une meta description trop longue pour déclencher la famille des descriptions non indexables sur la page en français de Noyaru Stack Gatsby, 2023." />
