...
export function Head() {
  return (
    <>
      ...
      <meta name="description" content="Une meta description trop longue pour dépasser le plafond de cent soixante caractères, afin de déclencher les descriptions trop longues." />
