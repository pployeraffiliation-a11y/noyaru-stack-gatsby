...
export function Head() {
  return (
    <>
      ...
      <meta name="description" content="Une meta description volontairement longue pour dépasser le plafond de 160 caractères, afin de déclencher des descriptions trop longues sur une page." />
