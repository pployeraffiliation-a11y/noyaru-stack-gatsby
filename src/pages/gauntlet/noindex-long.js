...
export function Head() {
  return (
    <>
      ...
      <title>Un titre volontairement trop long pour la fenetre du correcteur</title>
      <meta name="description" content="Une meta description volontairement tres longue, ecrite pour depasser le plafond de caracteres et declencher la famille des descriptions trop longues." />
