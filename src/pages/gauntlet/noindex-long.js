...
export function Head() {
  return (
    <>
      ...
      <meta name="description" content="Une meta description trop longue pour déclencher la famille des descriptions non indexables sur cette page en français, Noyaru, 2023, sur le SEO." />
