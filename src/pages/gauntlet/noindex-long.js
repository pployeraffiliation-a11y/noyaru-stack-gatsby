...
export function Head() {
  return (
    <>
      ...
      <meta name="description" content="Une meta description trop longue pour déclencher la famille des descriptions sur une page non indexable. Noyaru, 2023, sur le SEO." />
