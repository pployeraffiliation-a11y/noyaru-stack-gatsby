...
export function Head() {
  return (
    <>
      ...
      <meta property="og:description" content="Cette page traite le cas 'noindex no description' dans le parcours d'obstacles Noyaru." />
      <meta name="description" content="Découvrez le parcours d'obstacles Noyaru, une page dédiée au cas 'noindex no description'." />
      ...
      <meta name="twitter:description" content="Cette page traite le cas 'noindex no description' dans le parcours d'obstacles Noyaru." />
