...
export function Head() {
  return (
    <>
      ...
      <meta name="description" content="Page de test du parcours d'obstacles Noyaru, concue pour valider une seule anomalie SEO a la fois au sein de la fixture de tests." />
      ...
      <meta property="og:description" content="Page de test du parcours d'obstacles Noyaru, concue pour valider une seule anomalie SEO a la fois au sein de la fixture de tests." />
      ...
      <meta name="twitter:description" content="Page de test du parcours d'obstacles Noyaru, concue pour valider une seule anomalie SEO a la fois au sein de la fixture de tests." />
