...
export function Head() {
  return (
    <>
      ...
      <meta name="description" content="Découvrez le parcours d'obstacles avec une anomalie hreflang same language, afin de déclencher la famille des anomalies spécifiques au crawl." />
