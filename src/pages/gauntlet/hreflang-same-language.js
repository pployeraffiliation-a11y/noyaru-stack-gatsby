...
export function Head() {
  return (
    <>
      ...
      <meta name="description" content="Découvrez le parcours d'obstacles hreflang same language, illustrant un cas spécifique pour la famille visée lors du crawl." />
