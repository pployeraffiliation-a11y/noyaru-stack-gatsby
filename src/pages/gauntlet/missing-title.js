...
export function Head() {
  return (
    <>
      <title>Parcours d'obstacles : anomalie de titre manquant</title>
      ...
      <meta property="og:title" content="Parcours d'obstacles : anomalie de titre manquant" />
      ...
      <meta name="twitter:title" content="Parcours d'obstacles : anomalie de titre manquant" />
