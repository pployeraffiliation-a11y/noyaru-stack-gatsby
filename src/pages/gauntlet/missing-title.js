...
export function Head() {
  return (
    <>
      <title>Parcours d'obstacles : anomalie titre manquant</title>
      ...
      <meta property="og:title" content="Parcours d'obstacles : anomalie titre manquant" />
      ...
      <meta name="twitter:title" content="Parcours d'obstacles : anomalie titre manquant" />
