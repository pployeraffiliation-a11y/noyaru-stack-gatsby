...
export function Head() {
  return (
    <>
      ...
      <title>Parcours d'obstacles Noyaru - Hreflang Invalid</title>
      <meta name="description" content="Découvrez le parcours d'obstacles unique, conçu pour tester vos limites et compétences. Relevez le défi dès maintenant !" />
