...
export function Head() {
  return (
    <>
      ...
      <meta name="description" content="Découvrez le parcours d'obstacles avec une anomalie hreflang invalid, qui illustre un cas spécifique pour la famille visée lors du crawl." />
