...
export function Head() {
  return (
    <>
      ...
      <title>Parcours d'obstacles : duplicate a - Test de doublon</title>
      <meta name="description" content="Découvrez le parcours d'obstacles avec une anomalie unique à cette page, afin de déclencher la famille des doublons." />
      <link rel="canonical" href="https://noyaru-stack-gatsby.netlify.app/gauntlet/duplicate-a/" />
      <meta property="og:type" content="article" />
      <meta property="og:title" content="Parcours d'obstacles : duplicate a - Test de doublon" />
      ...
      <meta name="twitter:title" content="Parcours d'obstacles : duplicate a - Test de doublon" />
