...
export function Head() {
  return (
    <>
      ...
      <meta name="description" content="Découvrez le parcours d'obstacles 'duplicate a', une page dédiée à une anomalie unique pour les développeurs, à explorer en profondeur." />
      <link rel="canonical" href="https://noyaru-stack-gatsby.netlify.app/gauntlet/duplicate-a/" />
      <meta property="og:type" content="article" />
      <meta property="og:title" content="Parcours d'obstacles : duplicate a - Test de duplication" />
      ...
      <meta name="twitter:title" content="Parcours d'obstacles : duplicate a - Test de duplication" />
