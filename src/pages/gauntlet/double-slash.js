...
export function Head() {
  return (
    <>
      ...
      <meta name="description" content="Page dediee au test de la double barre dans une URL interne : ce parcours d'obstacles isole l'anomalie double_slash_in_url pour la reperer au crawl." />
      <link rel="canonical" href="https://noyaru-stack-gatsby.netlify.app/gauntlet/double-slash/" />
      <meta property="og:type" content="article" />
      <meta property="og:title" content="Page de test du parcours d'obstacles Noyaru" />
      <meta property="og:description" content="Page dediee au test de la double barre dans une URL interne : ce parcours d'obstacles isole l'anomalie double_slash_in_url pour la reperer au crawl." />
      ...
      <meta name="twitter:description" content="Page dediee au test de la double barre dans une URL interne : ce parcours d'obstacles isole l'anomalie double_slash_in_url pour la reperer au crawl." />
