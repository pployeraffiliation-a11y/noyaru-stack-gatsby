...
export function Head() {
  return (
    <>
      ...
      <meta name="description" content="Découvrez le parcours d'obstacles avec un double slash dans l'URL, une anomalie unique à cette page." />
      <link rel="canonical" href="https://noyaru-stack-gatsby.netlify.app/gauntlet/double-slash/" />
      <meta property="og:type" content="article" />
      <meta property="og:title" content="Page de test du parcours d'obstacles Noyaru" />
      <meta property="og:description" content="Découvrez le parcours d'obstacles avec un double slash dans l'URL, une anomalie unique à cette page." />
      ...
      <meta name="twitter:description" content="Découvrez le parcours d'obstacles avec un double slash dans l'URL, une anomalie unique à cette page." />
