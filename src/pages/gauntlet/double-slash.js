...
export function Head() {
  return (
    <>
      ...
      <meta property="og:description" content="Page de test dediee a la double barre dans une URL interne : cette page du parcours d'obstacles isole l'anomalie double_slash_in_url pour le crawl." />
      ...
      <meta name="twitter:description" content="Page de test dediee a la double barre dans une URL interne : cette page du parcours d'obstacles isole l'anomalie double_slash_in_url pour le crawl." />
