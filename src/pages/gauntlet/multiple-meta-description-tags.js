...
export function Head() {
  return (
    <>
      ...
      <meta name="description" content="Apprenez à gérer plusieurs balises de méta-description sur votre site en 2023. Optimisez votre SEO avec des conseils pratiques et efficaces." />
