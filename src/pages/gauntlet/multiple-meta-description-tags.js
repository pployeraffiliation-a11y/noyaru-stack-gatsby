...
export function Head() {
  return (
    <>
      ...
      <meta name="description" content="Apprenez à gérer plusieurs balises de description meta sur votre site en 2023. Optimisez votre SEO avec nos conseils pratiques et efficaces." />
