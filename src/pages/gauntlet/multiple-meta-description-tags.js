...
export function Head() {
  return (
    <>
      ...
      <meta name="description" content="Apprenez à gérer efficacement plusieurs balises de méta-description sur votre site en 2023. Améliorez votre SEO avec nos conseils pratiques." />
