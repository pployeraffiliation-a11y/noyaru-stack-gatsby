...
export function Head() {
  return (
    <>
      ...
      <meta name="description" content="Découvrez comment gérer plusieurs balises de description meta sur votre site en 2023. Optimisez votre SEO avec des conseils pratiques et efficaces." />
