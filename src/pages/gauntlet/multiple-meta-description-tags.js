...
export function Head() {
  return (
    <>
      ...
      <meta name="description" content="Apprenez à gérer plusieurs balises meta description sur votre site en 2023 avec Noyaru. Améliorez votre SEO et attirez plus de visiteurs." />
