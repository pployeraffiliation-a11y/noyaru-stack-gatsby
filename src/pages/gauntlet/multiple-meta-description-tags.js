...
export function Head() {
  return (
    <>
      ...
      <meta name="description" content="Une seconde description détaillant la gestion des balises meta description multiples sur une même page et leur impact concret sur le référencement SEO." />
