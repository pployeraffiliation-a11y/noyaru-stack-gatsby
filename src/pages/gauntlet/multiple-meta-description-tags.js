...
export function Head() {
  return (
    <>
      ...
      <meta name="description" content="Découvrez comment gérer les balises meta description multiples sur une page : bonnes pratiques SEO, erreurs fréquentes et impact sur le référencement." />
