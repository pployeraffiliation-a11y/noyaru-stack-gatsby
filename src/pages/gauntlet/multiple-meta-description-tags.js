...
export function Head() {
  return (
    <>
      ...
      <meta name="description" content="Apprenez à gérer plusieurs balises de description meta sur votre site en 2023 avec Noyaru. Optimisez votre SEO et améliorez votre visibilité!" />
